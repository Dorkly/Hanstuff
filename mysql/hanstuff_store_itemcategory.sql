...
--
-- Dumping data for table `store_itemcategory`
--

LOCK TABLES `store_itemcategory` WRITE;
/*!40000 ALTER TABLE `store_itemcategory` DISABLE KEYS */;
/*!40000 ALTER TABLE `store_itemcategory` ENABLE KEYS */;
UNLOCK TABLES;
